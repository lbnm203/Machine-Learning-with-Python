...
def show_experiment_selector():
    ...
    if train_runs:
        ...
        if train_df is not None and not train_df.empty:
            ...
            # selected_train_run_ids = [run.info.run_id for run in train_runs if run.data.tags.get(
            #     "mlflow.runName", run.info.run_id) in selected_train_runs]
